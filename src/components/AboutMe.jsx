    ...
    return (
        <Box sx={{ mb: 8 }}>
            <Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 } }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.7, mb: 3 }} paragraph>
                    I get a kick out of designing systems built to handle serious scale (millions of connected devices!), optimizing performance, and helping engineering teams thrive. You'll often find me working with embedded Linux (C/C++), cloud infrastructure, puzzling out system designs, or dabbling in cryptography.
                </Typography>
                <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.7, mb: 3 }} paragraph>
